...
def get_environment_variables():
    ...
    필수 환경 변수:
        ...
        - SERVICE_ACCOUNT_JSON_BASE64 (base64로 인코딩된 Google Service Account JSON)
    """
...
def navigate_to_order_history(driver, wait):
    ...
    order_history_selector = (
        ...
        "div.frame-aside > nav > div.MenuList-module__lZzf.LNB-module__foKc > "
        "ul:nth-child(10) > a:nth-child(1) > button"
    )
